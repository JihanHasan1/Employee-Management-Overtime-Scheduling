...
public class Moderator_Data extends SQLiteOpenHelper {

    // TABLE INFORMATION
    static final String DB_NAME = "MODERATOR_DATA.DB";
    public final String TABLE_KEY_VALUE = "moderator_pairs";
    public final String KEY = "keyname";
    public final String VALUE = "itemvalue";
    //
    private Context context;
    public Moderator_Data(Context context) {
...
public Integer deleteDataByKey(String key) {
    ...
    try {
        ...
        // Also, delete from the user database
        ...
        if (value != null) {
            ...
            System.out.println("Deleted data from User");
    ...
    public String getValueByKey1(String key) {
        SQLiteDatabase db = this.getWritableDatabase();
        String value = null;
        Cursor cursor = db.rawQuery("SELECT " + VALUE + " FROM " + TABLE_KEY_VALUE + " WHERE " + KEY + "=?", new String[]{key});
